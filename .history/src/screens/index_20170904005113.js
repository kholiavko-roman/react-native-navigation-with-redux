...
export function registerScreens(store, Provider) {
  ...
  Navigation.registerComponent('drawer', () => wrapWithNavigation(Drawer), store, Provider);
  Navigation.registerComponent('splash', () => wrapWithNavigation(Splash), store, Provider);
}
